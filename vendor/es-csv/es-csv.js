// See https://github.com/vanillaes/csv-es (MIT-license)
...
var CSV = {
     ...
     */
    parse: function (csv, options, reviver = v => v) {
     ...
     */
    stringify: function (array, options = {}, replacer = v => v) {
        const ctx = Object.create(null);
        ctx.options = options;
